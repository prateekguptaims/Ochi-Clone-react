...
function Footer() {
    return (
        <div className='w-full h-screen bg-zinc-900 flex px-20 py-20 gap-5'>
            <div className="w-1/2 h-full flex flex-col justify-between font-['Founders_Grotesk_X-Condensed'] ">
                <div className="heading ">

                    <h1 className='text-[6vw] font-semibold uppercase leading-none -mb-10 font-["Founders_Grotesk_X-Condensed"]'>Eye-</h1>
                    <h1 className='text-[6vw] font-semibold uppercase leading-none -mb-10 font-["Founders_Grotesk_X-Condensed"]'>Opening</h1>
                </div>
            ...
            <div className="w-1/2 font-['Founders_Grotesk_X-Condensed'] ">
                <h1 className="font-['Founders_Grotesk_X-Condensed'] text-[6vw] font-semibold uppercase">Presntations</h1>
                <div className='dets font-["Neue-Montreal"] mt-10'>
                <a className='block text-2xl font-light underline' href="#">Facebook</a>
                <a className='block text-2xl font-light underline' href="#">Twitter</a>
                <a className='block text-2xl font-light underline' href="#">Instagram</a>
